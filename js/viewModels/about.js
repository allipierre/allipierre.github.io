...
define(['ojs/ojcore', 'knockout', 'jquery', 'ojs/ojknockout', 'promise', 'ojs/ojinputtext', 'ojs/ojinputnumber', 'ojs/ojtable', 'ojs/ojarraytabledatasource'],
    function(oj, ko, $) {
        ...
        function AboutViewModel() {
            ...
            self.datasource = new oj.ArrayTableDataSource(deptArray, {
            ...
            self.datasource_s = new oj.ArrayTableDataSource(self.depteObservableArray, {
                idAttribute: 'DepartmentId'
            });
            ...
            function currentRowListener(event, data) {
                ...
                if (data['option'] === 'currentRow' && data['value'] !== null) {
                    ...
                    var dept = self.depteObservableArray()[rowIndex];
                    self.inputDepartmentIds(dept['DepartmentId']);
